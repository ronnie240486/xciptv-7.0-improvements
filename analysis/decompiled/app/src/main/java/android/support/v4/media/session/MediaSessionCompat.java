...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((d) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new d(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        c.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, extraBinder == null ? null : extraBinder.asBinder());
                        InterfaceC0273c session2Token = sessionToken.getSession2Token();
                        ...
                        if (i7 >= 0 && i7 < sessionImplIfCallbackIsSet.mQueue.size()) {
                            queueItem = sessionImplIfCallbackIsSet.mQueue.get(i7);
                        }
                        if (queueItem != null) {
            ...
            public void onSkipToQueueItem(long j7) {
                ...
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onSkipToQueueItem(j7);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            d currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setPlaybackToLocal(int i7);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            super(context, str, componentName, pendingIntent, interfaceC0273c, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase
        public int getRccTransportControlFlagsFromActions(long j7) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j7);
            return (j7 & 256) != 0 ? rccTransportControlFlagsFromActions | 256 : rccTransportControlFlagsFromActions;
        }
            ...
            if (callback == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi18.1
                    ...
                    public void onPlaybackPositionUpdate(long j7) {
                        MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(j7), null);
                    }
                });
            }
        }
            ...
            if (playbackStateCompat.getState() == 3) {
                ...
                if (position > 0) {
                    if (lastPositionUpdateTime > 0) {
                        j7 = elapsedRealtime - lastPositionUpdateTime;
                        if (playbackSpeed > 0.0f && playbackSpeed != 1.0f) {
                            j7 = (long) (j7 * playbackSpeed);
                        }
                    }
                    position += j7;
                }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            super(context, str, componentName, pendingIntent, interfaceC0273c, bundle);
        }
        ...
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                buildRccMetadata.putObject(Endpoint.TARGET_FIELD_NUMBER, (Object) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
            }
        ...
        public int getRccTransportControlFlagsFromActions(long j7) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j7);
            return (j7 & 128) != 0 ? rccTransportControlFlagsFromActions | IMediaList.Event.ItemAdded : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            super(context, str, interfaceC0273c, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setRatingType(int i7) {
            this.mSessionFwk.setRatingType(i7);
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            super(context, str, interfaceC0273c, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final d getCurrentControllerInfo() {
            ...
            dVar.f806a = new e(packageName2, pid, uid);
            return dVar;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(d dVar) {
        }
    }

    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            super(context, str, interfaceC0273c, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int mFlags = 3;
        private g mVolumeCallback = new g() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            public void onVolumeChanged(h hVar) {
                MediaSessionImplBase.this.getClass();
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                int i7 = mediaSessionImplBase.mVolumeType;
                int i8 = mediaSessionImplBase.mLocalStream;
                throw null;
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i7) {
                postToHandler(26, mediaDescriptionCompat, i7);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int i7, int i8, String str) {
                MediaSessionImplBase.this.adjustVolume(i7, i8);
            }
            ...
            public long getFlags() {
                long j7;
                synchronized (MediaSessionImplBase.this.mLock) {
                    j7 = MediaSessionImplBase.this.mFlags;
                }
                return j7;
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    i7 = mediaSessionImplBase.mVolumeType;
                    i8 = mediaSessionImplBase.mLocalStream;
                    mediaSessionImplBase.getClass();
                    if (i7 == 2) {
                        throw null;
                    }
                    streamMaxVolume = MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(i8);
                    streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i8);
                }
                return new ParcelableVolumeInfo(i7, i8, 2, streamMaxVolume, streamVolume);
            }
            ...
            public void postToHandler(int i7) {
                MediaSessionImplBase.this.postToHandler(i7, 0, 0, null, null);
            }
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new d(MediaSessionImplBase.this.getPackageNameForUid(callingUid), callingPid, callingUid));
                synchronized (MediaSessionImplBase.this.mLock) {
                    try {
            ...
            public void seekTo(long j7) {
                postToHandler(18, Long.valueOf(j7));
            }
            ...
            public void setPlaybackSpeed(float f7) {
                postToHandler(32, Float.valueOf(f7));
            }
            ...
            public void setVolumeTo(int i7, int i8, String str) {
                MediaSessionImplBase.this.setVolumeTo(i7, i8);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void skipToQueueItem(long j7) {
                postToHandler(11, Long.valueOf(j7));
            }
            ...
            public void postToHandler(int i7, int i8) {
                MediaSessionImplBase.this.postToHandler(i7, i8, 0, null, null);
            }

            public void postToHandler(int i7, int i8, int i9) {
                MediaSessionImplBase.this.postToHandler(i7, i8, i9, null, null);
            }

            public void postToHandler(int i7, Object obj) {
                MediaSessionImplBase.this.postToHandler(i7, 0, 0, obj, null);
            }

            public void postToHandler(int i7, Object obj, int i8) {
                MediaSessionImplBase.this.postToHandler(i7, i8, 0, obj, null);
            }

            public void postToHandler(int i7, Object obj, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(i7, 0, 0, obj, bundle);
            }
        }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new d(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
                ...
                try {
                    switch (message.what) {
                        ...
                        case 28:
                            ...
                            if (list != null) {
                                int i7 = message.arg1;
                                QueueItem queueItem = (i7 < 0 || i7 >= list.size()) ? null : MediaSessionImplBase.this.mQueue.get(message.arg1);
                                if (queueItem != null) {
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionStub, null, interfaceC0273c);
            this.mRatingType = 0;
            this.mVolumeType = 1;
            this.mLocalStream = 3;
        ...
        private void sendRepeatMode(int i7) {
            synchronized (this.mLock) {
                for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i7);
                    } catch (RemoteException unused) {
                    }
                }
                this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i7) {
            synchronized (this.mLock) {
                for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i7);
                    } catch (RemoteException unused) {
                    }
                }
                this.mControllerCallbacks.finishBroadcast();
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public d getCurrentControllerInfo() {
            d dVar;
            synchronized (this.mLock) {
        ...
        public String getPackageNameForUid(int i7) {
            String nameForUid = this.mContext.getPackageManager().getNameForUid(i7);
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (messageHandler != null) {
                        Message obtainMessage = messageHandler.obtainMessage(i7, i8, i9, obj);
                        Bundle bundle2 = new Bundle();
                        int callingUid = Binder.getCallingUid();
        ...
        */
        ...
        public void setPlaybackToLocal(int i7) {
            ...
            this.mVolumeType = 1;
            int i8 = this.mVolumeType;
            int i9 = this.mLocalStream;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(i8, i9, 2, this.mAudioManager.getStreamMaxVolume(i9), this.mAudioManager.getStreamVolume(this.mLocalStream)));
        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public static class Api21Impl {
            ...
            public static MediaSession.QueueItem createQueueItem(MediaDescription mediaDescription, long j7) {
        ...
        public String toString() {
            ...
            sb.append(", Id=");
            return android.support.v4.media.a.q(sb, this.mId, " }");
        }
    ...
    public static final class RegistrationCallbackHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i7 == 1001) {
                ...
                if (i7 != MSG_CALLBACK_UNREGISTERED) {
                    return;
                }
        ...
        public void postCallbackRegistered(int i7, int i8) {
            obtainMessage(1001, i7, i8).sendToTarget();
        }

        public void postCallbackUnregistered(int i7, int i8) {
            obtainMessage(MSG_CALLBACK_UNREGISTERED, i7, i8).sendToTarget();
        }
    }
    ...
    public static final class Token implements Parcelable {
        ...
        private InterfaceC0273c mSession2Token;
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            InterfaceC0273c m7 = f.m(bundle);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, asInterface, m7);
        }
        ...
        public InterfaceC0273c getSession2Token() {
            InterfaceC0273c interfaceC0273c;
            synchronized (this.mLock) {
                interfaceC0273c = this.mSession2Token;
            }
        ...
        public void setSession2Token(InterfaceC0273c interfaceC0273c) {
            synchronized (this.mLock) {
                this.mSession2Token = interfaceC0273c;
            }
        }
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (iMediaSession != null) {
                        c.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                    }
                    InterfaceC0273c interfaceC0273c = this.mSession2Token;
                    if (interfaceC0273c != null) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putParcelable("a", new ParcelImpl(interfaceC0273c));
        ...
        public Token(Object obj, IMediaSession iMediaSession, InterfaceC0273c interfaceC0273c) {
    ...
    public static MediaSessionCompat fromMediaSession(Context context, Object obj) {
        ...
        return new MediaSessionCompat(context, i7 >= 29 ? new MediaSessionImplApi29(obj) : i7 >= 28 ? new MediaSessionImplApi28(obj) : new MediaSessionImplApi21(obj));
    }
    ...
    public static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        if (mediaMetadataCompat != null && mediaMetadataCompat.containsKey(MediaMetadataCompat.METADATA_KEY_DURATION)) {
            j7 = mediaMetadataCompat.getLong(MediaMetadataCompat.METADATA_KEY_DURATION);
        }
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), (j7 < 0 || position <= j7) ? position < 0 ? 0L : position : j7, playbackStateCompat.getPlaybackSpeed(), elapsedRealtime).build();
    }
    ...
    public void setPlaybackToLocal(int i7) {
        this.mImpl.setPlaybackToLocal(i7);
    }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, InterfaceC0273c interfaceC0273c) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (i8 >= 29) {
                    this.mImpl = new MediaSessionImplApi29(context, str, interfaceC0273c, bundle);
                } else if (i8 >= 28) {
                    this.mImpl = new MediaSessionImplApi28(context, str, interfaceC0273c, bundle);
                } else if (i8 >= 22) {
                    this.mImpl = new MediaSessionImplApi22(context, str, interfaceC0273c, bundle);
                } else {
                    this.mImpl = new MediaSessionImplApi21(context, str, interfaceC0273c, bundle);
                }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                int callingPid = Binder.getCallingPid();
                int callingUid = Binder.getCallingUid();
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new d("android.media.session.MediaController", callingPid, callingUid));
        ...
        public MediaSessionImplApi21(Context context, String str, InterfaceC0273c interfaceC0273c, Bundle bundle) {
            MediaSession createFwkMediaSession = createFwkMediaSession(context, str, bundle);
            this.mSessionFwk = createFwkMediaSession;
            this.mToken = new Token(createFwkMediaSession.getSessionToken(), new ExtraSession(), interfaceC0273c);
            this.mSessionInfo = bundle;
            setFlags(3);
        }
        ...
        public String getCallingPackage() {
            ...
            try {
                ...
                Log.e(MediaSessionCompat.TAG, "Cannot execute MediaSession.getCallingPackage()", e7);
                return null;
            }
        }
        ...
        public void release() {
            ...
            if (Build.VERSION.SDK_INT == 27) {
                try {
                    ...
                    Log.w(MediaSessionCompat.TAG, "Exception happened while accessing MediaSession.mCallback.", e7);
                }
            }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setFlags(int i7) {
            this.mSessionFwk.setFlags(i7 | 3);
        }
        ...
        public void setRepeatMode(int i7) {
            if (this.mRepeatMode != i7) {
                ...
                synchronized (this.mLock) {
                    for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                        try {
                            this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i7);
                        } catch (RemoteException unused) {
                        }
                    }
                    this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int i7) {
            if (this.mShuffleMode != i7) {
                ...
                synchronized (this.mLock) {
                    for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                        try {
                            this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i7);
                        } catch (RemoteException unused) {
                        }
                    }
                    this.mExtraControllerCallbacks.finishBroadcast();
