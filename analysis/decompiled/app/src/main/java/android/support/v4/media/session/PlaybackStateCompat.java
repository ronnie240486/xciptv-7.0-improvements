...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static class Api21Impl {
        ...
        public static PlaybackState.CustomAction.Builder createCustomActionBuilder(String str, CharSequence charSequence, int i7) {
        ...
        public static void setActions(PlaybackState.Builder builder, long j7) {
            builder.setActions(j7);
        }

        public static void setActiveQueueItemId(PlaybackState.Builder builder, long j7) {
            builder.setActiveQueueItemId(j7);
        }

        public static void setBufferedPosition(PlaybackState.Builder builder, long j7) {
        ...
        public static void setState(PlaybackState.Builder builder, int i7, long j7, float f7, long j8) {
    ...
    public String toString() {
        ...
        return android.support.v4.media.a.q(sb, this.mActiveItemId, "}");
    }
