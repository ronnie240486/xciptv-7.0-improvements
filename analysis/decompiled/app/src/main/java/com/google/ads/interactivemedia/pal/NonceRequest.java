...
public abstract class NonceRequest {
    ...
    public static Builder builder() {
        ...
        zzlVar.descriptionURL(HttpUrl.FRAGMENT_ENCODE_SET);
        zzlVar.omidPartnerName(HttpUrl.FRAGMENT_ENCODE_SET);
        zzlVar.omidPartnerVersion(HttpUrl.FRAGMENT_ENCODE_SET);
        zzlVar.omidVersion(HttpUrl.FRAGMENT_ENCODE_SET);
        zzlVar.playerType(HttpUrl.FRAGMENT_ENCODE_SET);
        zzlVar.playerVersion(HttpUrl.FRAGMENT_ENCODE_SET);
        zzlVar.ppid(HttpUrl.FRAGMENT_ENCODE_SET);
