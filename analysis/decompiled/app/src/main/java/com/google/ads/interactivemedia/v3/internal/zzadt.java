...
final class zzadt extends zzadv {
    ...
    public /* synthetic */ zzadt(byte[] bArr, int i7, int i8, boolean z7, zzads zzadsVar) {
        super(null);
        this.zzk = d.API_PRIORITY_OTHER;
        this.zze = bArr;
        this.zzf = i8 + i7;
        this.zzh = i7;
        this.zzi = i7;
    ...
    public final zzadr zzj() {
        ...
        if (zze > 0) {
            ...
            int i8 = this.zzh;
            if (zze <= i7 - i8) {
                zzadr zzs = zzadr.zzs(this.zze, i8, zze);
                this.zzh += zze;
                return zzs;
            }
        }
        ...
        if (zze > 0) {
            ...
            if (zze <= i9 - i10) {
                int i11 = zze + i10;
                this.zzh = i11;
                return new zzado(Arrays.copyOfRange(this.zze, i10, i11));
            }
        }
        if (zze <= 0) {
            throw zzafc.zzf();
    ...
    public final String zzk() {
        ...
        if (zze > 0) {
            ...
            int i8 = this.zzh;
            if (zze <= i7 - i8) {
                String str = new String(this.zze, i8, zze, zzafa.zzb);
                this.zzh += zze;
                return str;
            }
        }
    ...
    public final String zzl() {
        ...
        if (zze > 0) {
            ...
            int i8 = this.zzh;
            if (zze <= i7 - i8) {
                String zzg = zzahy.zzg(this.zze, i8, zze);
                this.zzh += zze;
                return zzg;
            }
        }
