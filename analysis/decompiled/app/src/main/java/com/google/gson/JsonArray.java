...
public final class JsonArray extends JsonElement implements Iterable<JsonElement> {
    ...
    private JsonElement getAsSingleElement() {
        ...
        throw new IllegalStateException(y.h("Array must have size 1, but has size ", size));
    }
    ...
    public JsonElement get(int i7) {
        return this.elements.get(i7);
    }
    ...
    public JsonElement set(int i7, JsonElement jsonElement) {
    ...
    public JsonElement remove(int i7) {
        return this.elements.remove(i7);
    }
