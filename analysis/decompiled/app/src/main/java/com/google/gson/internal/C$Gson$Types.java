    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i7 = 0; i7 < length; i7++) {
                Objects.requireNonNull(this.typeArguments[i7]);
                C$Gson$Types.checkNotPrimitive(this.typeArguments[i7]);
                Type[] typeArr3 = this.typeArguments;
                typeArr3[i7] = C$Gson$Types.canonicalize(typeArr3[i7]);
            }
        }
        ...
        public String toString() {
            ...
            for (int i7 = 1; i7 < length; i7++) {
                sb.append(", ");
                sb.append(C$Gson$Types.typeToString(this.typeArguments[i7]));
            }
            sb.append(">");
            return sb.toString();
        }
        ...
        if (cls2.isInterface()) {
            ...
            for (int i7 = 0; i7 < length; i7++) {
                ...
                if (cls2.isAssignableFrom(cls3)) {
                    return getGenericSupertype(cls.getGenericInterfaces()[i7], interfaces[i7], cls2);
                }
            }
        }
        if (!cls.isInterface()) {
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (type2 instanceof GenericArrayType) {
                    ...
                    if (type2 instanceof ParameterizedType) {
                        ...
                        for (int i7 = 0; i7 < length; i7++) {
                            Type resolve4 = resolve(type, cls, actualTypeArguments[i7], map);
                            if (!equal(resolve4, actualTypeArguments[i7])) {
                                if (!z7) {
                                    actualTypeArguments = (Type[]) actualTypeArguments.clone();
                                    z7 = true;
                                }
                                actualTypeArguments[i7] = resolve4;
                            }
                        }
                        if (z7) {
