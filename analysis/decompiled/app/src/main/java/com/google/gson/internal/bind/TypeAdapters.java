    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read2(JsonReader jsonReader) {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i8 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                    if (i8 == 1 || i8 == 2) {
                        int nextInt = jsonReader.nextInt();
                        if (nextInt != 0) {
                            if (nextInt != 1) {
                                StringBuilder l7 = y.l("Invalid bitset value ", nextInt, ", expected 0 or 1; at path ");
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read2(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder l7 = y.l("Lossy conversion from ", nextInt, " to byte; at path ");
                    l7.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(l7.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read2(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder l7 = y.l("Lossy conversion from ", nextInt, " to short; at path ");
                    l7.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(l7.toString());
                } catch (NumberFormatException e7) {
                    throw new JsonSyntaxException(e7);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read2(JsonReader jsonReader) {
                ...
                StringBuilder t7 = a.t("Expecting character, got: ", nextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read2(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder t7 = a.t("Failed parsing '", nextString, "' as BigDecimal; at path ");
                    t7.append(jsonReader.getPreviousPath());
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read2(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder t7 = a.t("Failed parsing '", nextString, "' as BigInteger; at path ");
                    t7.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(t7.toString(), e7);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read2(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder t7 = a.t("Failed parsing '", nextString, "' as UUID; at path ");
                    t7.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(t7.toString(), e7);
                }
            }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read2(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder t7 = a.t("Failed parsing '", nextString, "' as Currency; at path ");
                    t7.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(t7.toString(), e7);
                }
            }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) {
                int i7 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i7 == 1) {
