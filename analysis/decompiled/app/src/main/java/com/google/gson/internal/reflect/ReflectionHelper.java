...
public class ReflectionHelper {
    ...
    public static class RecordSupportedHelper extends RecordHelper {
        ...
        public <T> Constructor<T> getCanonicalRecordConstructor(Class<T> cls) {
            try {
                ...
                for (int i7 = 0; i7 < objArr.length; i7++) {
                    clsArr[i7] = (Class) this.getType.invoke(objArr[i7], new Object[0]);
                }
        ...
        public String[] getRecordComponentNames(Class<?> cls) {
            try {
                ...
                for (int i7 = 0; i7 < objArr.length; i7++) {
                    strArr[i7] = (String) this.getName.invoke(objArr[i7], new Object[0]);
                }
                return strArr;
            } catch (ReflectiveOperationException e7) {
                throw ReflectionHelper.createExceptionForRecordReflectionException(e7);
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) {
        try {
            ...
            throw new JsonIOException(a.p("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type."), e7);
        }
    }
    ...
    public static String tryMakeAccessible(Constructor<?> constructor) {
        try {
            ...
            return "Failed making constructor '" + constructorToString(constructor) + "' accessible; either increase its visibility or write a custom InstanceCreator or TypeAdapter for its declaring type: " + e7.getMessage();
        }
    }
}
