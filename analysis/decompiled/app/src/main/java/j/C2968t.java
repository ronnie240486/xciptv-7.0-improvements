...
public final class C2968t extends CheckBox implements InterfaceC3406v {

    /* renamed from: A, reason: collision with root package name */
    public C2905A f24335A;

    /* renamed from: x, reason: collision with root package name */
    public final C2972v f24336x;

    /* renamed from: y, reason: collision with root package name */
    public final r f24337y;

    /* renamed from: z, reason: collision with root package name */
    public final C2938h0 f24338z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2968t(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.checkboxStyle);
        y1.a(context);
        x1.a(getContext(), this);
        C2972v c2972v = new C2972v(this, 1);
        this.f24336x = c2972v;
        c2972v.c(attributeSet, R.attr.checkboxStyle);
        r rVar = new r(this);
        this.f24337y = rVar;
        rVar.d(attributeSet, R.attr.checkboxStyle);
        C2938h0 c2938h0 = new C2938h0(this);
        this.f24338z = c2938h0;
        c2938h0.f(attributeSet, R.attr.checkboxStyle);
        getEmojiTextViewHelper().b(attributeSet, R.attr.checkboxStyle);
    }

    private C2905A getEmojiTextViewHelper() {
        if (this.f24335A == null) {
            this.f24335A = new C2905A(this);
        }
        return this.f24335A;
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f24338z.d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f24338z.e();
    }
