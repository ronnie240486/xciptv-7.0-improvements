...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            while (i7 < size) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (i.c(lowerCase, Http2ExchangeCodec.TE) && i.c(headers.value(i7), "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headers, Protocol protocol) {
            ...
            while (i7 < size) {
                ...
                if (i.c(name, Header.RESPONSE_STATUS_UTF8)) {
                    statusLine = StatusLine.Companion.parse(i.F(value, "HTTP/1.1 "));
    ...
    public Http2ExchangeCodec(OkHttpClient okHttpClient, RealConnection realConnection, RealInterceptorChain realInterceptorChain, Http2Connection http2Connection) {
        ...
        i.l(http2Connection, "http2Connection");
    ...
    public void writeRequestHeaders(Request request) {
        ...
        i.i(http2Stream2);
        E readTimeout = http2Stream2.readTimeout();
