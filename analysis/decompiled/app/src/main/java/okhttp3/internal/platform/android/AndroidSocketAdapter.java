...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> cls) {
            ...
            while (cls2 != null && !i.c(cls2.getSimpleName(), "OpenSSLSocketImpl")) {
                cls2 = cls2.getSuperclass();
                if (cls2 == null) {
                    throw new AssertionError(i.F(cls, "No OpenSSLSocketImpl superclass of socket of type "));
                }
            }
            i.i(cls2);
        ...
        public final DeferredSocketAdapter.Factory factory(final String str) {
            ...
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(SSLSocket sSLSocket) {
                    i.l(sSLSocket, "sslSocket");
                    return y6.i.S(sSLSocket.getClass().getName(), i.F(".", str), false);
                }
            };
        }
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> cls) {
        ...
        i.k(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        ...
        try {
            ...
            return new String(bArr, a.f28665a);
        } catch (IllegalAccessException e7) {
            throw new AssertionError(e7);
        } catch (InvocationTargetException e8) {
            Throwable cause = e8.getCause();
            if ((cause instanceof NullPointerException) && i.c(((NullPointerException) cause).getMessage(), "ssl == null")) {
                return null;
            }
            throw new AssertionError(e8);
        }
